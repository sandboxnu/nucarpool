        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="flex h-4/6 w-5/6 flex-col content-center justify-center gap-4 rounded-md bg-white p-9 shadow-md sm:h-4/6 sm:w-4/6 md:h-3/6 md:w-3/6">
            ...
            <div className="scroll overflow-y-auto">
              ...
              arrangements or services engaged in through this application. 
              </p>
              <br/>
              <p>
              This application and any related transportation services are created
              ...
              <br/>
              <p>
              By using this application and participating in
              ...
              <br/>
              <p>
              By using the Carpool service, you acknowledge that you may receive emails related to system events, actions taken by other users, updates to the service, and announcements about new features or products. 
              You also acknowledge that your email address may be shared with other users as necessary to facilitate carpool-related arrangements or interactions through the service. By clicking the ”I Agree button” below, 
              you confirm that you understand and accept these terms. These terms are subject to updates, and continued use of the service constitutes acknowledgment of those updates.
              </p>
